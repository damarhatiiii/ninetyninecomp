...
<body class="bg-gray-50">
    ...
    <main class="p-6 min-h-[calc(100vh-80px)] pb-20">
        <div class="max-w-7xl mx-auto">
            <!-- Header -->
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900">Halo, <?= htmlspecialchars($_SESSION['nama']); ?> 👋</h1>
                <p class="text-gray-600 mt-2">Selamat datang di dashboard toko komputer</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 max-w-xl w-full mx-auto mb-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Pendapatan Bulanan</h3>
                    <canvas id="revenueChart" height="200"></canvas>
                </div>

                <!-- Chart Jumlah Transaksi -->
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Jumlah Transaksi Bulanan</h3>
                    <canvas id="transactionChart" height="300"></canvas>
                </div>

                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 max-w-xl w-full mx-auto mb-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Penjualan Produk</h3>
                    <canvas id="productChart" height="200"></canvas>
                </div>

                <!-- === CARD: Transaksi Harian === -->
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 max-w-xl w-full mx-auto mb-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Transaksi Harian</h3>
